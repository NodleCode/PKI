...
use pki_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
    pub Executor,
    pki_runtime::api::dispatch,
    pki_runtime::native_version,
);
...
macro_rules! new_full_start {
    ($config:expr) => {{
        ...
        let builder = sc_service::ServiceBuilder::new_full::<
            pki_runtime::opaque::Block,
            pki_runtime::RuntimeApi,
